            ...
            <div class="container ">
                ...
                <a class="navbar-brand d-none d-sm-block {{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}} flex-shrink-0"
                   ...
                   style="min-width: 300px;"> <!-- -->
                    <img style="height: 60px!important; width:auto;"
                         src="{{asset("storage/app/public/company")."/".$web_config['web_logo']->value}}"
                         onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                         alt="{{$web_config['name']->value}}"/>
                </a>
                <a style="width: 80%"
                   class="navbar-brand d-sm-none {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}"
                   href="{{route('home')}}">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <div class="input-group-overlay d-md-none my-3">
                        <form action="{{route('products')}}" type="submit" class="search_form">
                            ...
                            <input name="page" value="1" hidden>
                            <button class="input-group-append-overlay search_button" type="submit"
                                    style="color:#fff;background:#000;padding: 1% 3% 4% 3%;border-radius: {{Session::get('direction') === "rtl" ? '7px 0px 0px 7px; right: unset; left: 0' : '0px 7px 7px 0px; left: unset; right: 0'}};">
                                Search
                    ...
                    <!-- Primary menu-->
                    <ul class="navbar-nav business-menu"
                        ...
                        @if ($business_mode == 'multi')
                            ...
                            <li class="nav-item">
                                <a style="padding-top: 1.125rem;padding-bottom: 0.875rem;padding-left: 15rem;"
                                   class="topbar-link d-none d-md-inline-block" href="https://wa.link/m6l4fr">
